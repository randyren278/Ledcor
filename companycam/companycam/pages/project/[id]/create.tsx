...
import { ArrowLeft, Loader2, CheckCircle, AlertCircle, Upload, Brain, FileText, Camera, Mic, Sparkles } from 'lucide-react';
import CameraRecorder from '../../../components/CameraRecorder';
import { getProject } from '../../../lib/data';
import { MediaData, RecordingStatus, Project } from '../../../types';
    ...
    switch (status) {
      ...
      case 'recording':
        return {
          ...
          subtitle: project ? `Adding to ${project.name}` : 'Loading project...',
          color: 'text-gray-900'
        };
      case 'uploading':
        return {
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mt-6 bg-purple-50 border border-purple-200 rounded-xl p-6">
              ...
              <p className="text-sm text-purple-800">
                Our AI will transcribe your audio, analyze your images, and create organized notes with summaries and insights automatically.
              </p>
            </div>
          </div>
        )}
        ...
        {status === 'success' && (
          <div className="max-w-md mx-auto text-center">
            <div className="bg-white rounded-2xl shadow-xl border border-green-200 p-8">
              ...
              <p className="text-gray-600 mb-6">
                Your note has been processed and added to {project?.name}.
              </p>
